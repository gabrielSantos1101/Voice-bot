...
Exclusive voice bot for the [**Lobbytech**](https://discord.gg/v9Nb6GQd) Discord server.

Standalone Discord voice bot for Text-to-Speech using edge-tts (Microsoft Edge TTS engine).

Converts text messages to spoken audio in Discord voice channels. Runs independently as a separate bot on the server.
